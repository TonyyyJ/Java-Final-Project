...
public class WekaClassifier {
    ...
    private static final String TRAIN_DATA = "final/train.txt";
    private static final String TRAIN_ARFF_ARFF = "final/train.arff";
    private static final String TEST_DATA = "final/test.txt";
    private static final String TEST_DATA_ARFF = "final/test.arff";
    ...
    public static void main(String[] args) throws Exception {
        ...
        LOGGER.info("Hey John, how are you? Let's catch up soon. Best, Alice " + wt.predict("Hey John, how are you? Let's catch up soon. Best, Alice"));
        LOGGER.info("Dear Sir/Madam, You have won a prize! Click here to claim it. " + wt.predict("Dear Sir/Madam, You have won a prize! Click here to claim it."));
        //run evaluation
